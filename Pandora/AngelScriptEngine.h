...
public:
	...
	static ByteCodeMemory<std::string>* loadPortal(std::string id);
	static ByteCodeMemory<std::string>* loadEvent(std::string id);
	static ByteCodeMemory<std::string>* loadChannelEvent(std::string id);
	static ByteCodeMemory<int>* loadReactor(int id);
	static int handlePortal(Player* player, MapPortalData* portal);
	static int handleEvent(Channel* channel, std::string& eventn);
	static int handleChannelEvent(Channel* channel, std::string& eventn);
