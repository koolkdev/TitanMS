...
int PlayerStats::exps[200] = {15, 34, 57, 92, 135, 372, 560, 840, 1242, 1716, 2360, 3216, 4200,
...
void PlayerStats::giveEXP(Player* player, int exp, char type){
...
void PlayerStats::addStat(Player* player, unsigned char* packet){
