...
bool Initializing::initializing(){
	ShowStatus("Initializing Settings... ");
	if(initializeSettings()) ShowMessage("DONE\n");
	else return 0;
	ShowStatus("Initializing Mobs... ");
	initializeMobs();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Items... ");
	initializeItems();
	ShowMessage("DONE\n");
	ShowStatus("Initializing NPCs Scripts... ");
	initializeNPCsScripts();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Portals Scripts... ");
	initializePortals();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Mobs Drops... ");
	initializeMobsDrops();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Equips... ");
	initializeEquips();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Shops... ");
	initializeShops();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Quests... ");
	initializeQuests();
	ShowMessage("DONE\n");	
	ShowStatus("Initializing Skills... ");
	initializeSkills();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Pets... ");
	initializePets();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Reactors... ");
	initializeReactors();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Reactors Scripts... ");
	initializeReactorScripts();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Reactors Drops... ");
	initializeReactorsDrops();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Events... ");
	initializeEvents();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Channel Events... ");
	initializeChannelEvents();
	ShowMessage("DONE\n");
	ShowStatus("Initializing Events Scripts... ");
